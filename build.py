...
def render(meta, body, out_rel):
    ...
    if layout == "bare":
        ...
        page = head + admin_shell(meta.get("active", ""), body) + "\n__SCRIPTS__\n</body>\n</html>\n"
    else:
        page = head + HEADER + "\n" + body + "\n" + FOOTER + "\n__SCRIPTS__\n</body>\n</html>\n"
...
ADMIN_NAV = [
    ("dashboard", "/admin/dashboard.html", '<rect x="3" y="3" width="7" height="9"/><rect x="14" y="3" width="7" height="5"/><rect x="14" y="12" width="7" height="9"/><rect x="3" y="16" width="7" height="5"/>', "Dashboard"),
    ("bookings", "/admin/bookings.html", '<rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/>', "Bookings"),
    ("customers", "/admin/customers.html", '<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/>', "Customers (CRM)"),
    ("schedule", "/admin/schedule.html", '<rect x="1" y="3" width="15" height="13"/><polygon points="16 8 20 8 23 11 23 16 16 16 16 8"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/>', "Schedule"),
    ("team", "/admin/team.html", '<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><polyline points="16 11 18 13 22 9"/>', "Team"),
    ("invoices", "/admin/invoices.html", '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/>', "Invoices"),
    ("settings", "/admin/settings.html", '<circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/>', "Settings"),
]

def admin_shell(active, content):
    nav = "".join(
        f'<li><a class="{"active" if k == active else ""}" href="{href}"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">{icon}</svg> {label}</a></li>'
        for k, href, icon, label in ADMIN_NAV)
    return f'''<div class="admin-banner">Front-end demo with sample data · in production this is auth-gated and reads live data from your CRM/API · <a href="/index.html">Back to website</a></div>
<div class="dash">
  <aside class="dash-side">
    <a class="brand" href="/index.html" aria-label="BlueLine Plumbing"><svg class="brand-mark" viewBox="0 0 40 40" aria-hidden="true"><rect width="40" height="40" rx="8" fill="#143A5E"/><path d="M20 9c4.5 5 7 8.4 7 11.8A7 7 0 0 1 13 20.8C13 17.4 15.5 14 20 9z" fill="#fff"/><circle cx="20" cy="21" r="2.6" fill="#F97316"/></svg><span style="color:#fff">Blue<span style="color:var(--blue-500)">Line</span></span></a>
    <nav aria-label="Admin"><ul class="dash-nav">
      {nav}
      <li style="margin-top:1.5rem;border-top:1px solid rgba(255,255,255,0.1);padding-top:1rem"><a href="/admin/login.html" data-signout><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg> Sign out</a></li>
    </ul></nav>
  </aside>
